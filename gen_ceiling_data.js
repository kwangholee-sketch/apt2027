...
// 웹조사·뉴스기사 확인 데이터
const newsConfirmed = {
  // 서울경제 기사 직접 확인 → pdfConfirmed로 이동 (천장높이약2400mm명시)
  // '영통자이센트럴파크': pdfConfirmed로 이동
...
const researchData = {
  ...
  'e편한세상명덕역퍼스트마크(주상복합)':                 { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '대구역센트레빌더오페라(주상복합)':                    { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '더폴디오션(주상복합)':                               { ceiling: '2.4m', source: '조사(주상복합기준)' },
  'e편한세상대전역센텀비스타(주상복합)':                 { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '더샵달서센트엘로(주상복합)':                          { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '해링턴플레이스테크노폴리스(주상복합)':                { ceiling: '2.4m', source: '조사(주상복합기준)' },
  'e편한세상범일국제금융시티(주상복합)':                  { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '신영지웰푸르지오테크노폴리스센트럴(주상복합)':        { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '동래에코팰리스아시아드(주상복합)':                    { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '에코시티한양수자인디에스틴(주상복합)':                { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '달서푸르지오시그니처(주)':                            { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '아산벨코어스위첸(주상복합)':                          { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '대전에테르스위첸(주)':                                { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '거제유림노르웨이숲디오션(주상복합)':                  { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '울진후포오션더캐슬(주상복합)':                        { ceiling: '2.4m', source: '조사(주상복합기준)' },
  '울산KTX우방아이유쉘퍼스트(주)':                       { ceiling: '2.4m', source: '조사(주상복합기준)' },
};
